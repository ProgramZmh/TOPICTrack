...
def draw_mot17(video_id,gt_path, save_dir):
    txt_name = gt_path + '/' + video_id + '.txt' 
    file_path_img = 'data/mot/test/' + video_id + '/img1' 
    frame_width = 1920
    frame_height = 1080
    output_video = os.path.join(save_dir,'mot17.mp4')
    ...
    for idx in name_dict:
        ...
        txt = 'MOT17  ' + 'frame: ' + str(frame) + '  num: ' + str(i + 1)
...
def main():
    ...
    for name in filename:
        ...
        draw_mot17(name.split('.')[0],folder,save_dir="video/")
