...
if __name__ == '__main__':
    # gt_path = '/remote-home/zhengyiyao/topictrack/results/trackers/MOT17-val/best_paper_ablations_test/data'
    # gt_path = '/remote-home/zhengyiyao/ByteTrack/YOLOX_outputs/yolox_x_ablation/track_results'
    gt_path = '/remote-home/zhengyiyao/topictrack/results/trackers/MOT17-val/baseline_mot17_test/data'
    # gt_path = '/remote-home/zhengyiyao/OC_SORT/evaldata/trackers/mot_challenge/MOT17-test/mot17_test_results/data'
    ...
    for name in filename:
        ...
        # draw_mot(name.split('.')[0],gt_path,save_dir="pic_track/mot17_trades/")
        # draw_mot(name.split('.')[0],gt_path,save_dir="pic_track/mot17_ocsort/")
        draw_mot(name.split('.')[0],gt_path,save_dir="pic_track/mot17_fairmot/")
