...
def get_main_args_debug():
    ...
    # )
    parser.add_argument("--w_assoc_emb", type=float,
                        default=1.25, help="Combine weight for emb cost")
    parser.add_argument(
        "--alpha_fixed_emb",
        type=float,
        default=0.95,
    ...
    parser.add_argument("--aw_param", type=float, default=1)
...
def main():
    ...
    for (img, np_img), label, info, idx in loader:
        ...
        # if video_name == 'dancetrack0011' and int(frame_id) == 347:
        #     print(1)
