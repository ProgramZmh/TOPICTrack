...
def draw_bee(video_id,gt_path, save_dir):
    txt_name = gt_path + '/' + video_id + '.txt'
    file_path_img = 'data/BEE23/test/' + video_id + '/img1'
    frame_width = 1920
    frame_height = 880
    output_video = os.path.join(save_dir,'bee.mp4')
    ...
    for idx in name_dict:
        ...
        txt = 'BEE23  ' + 'frame: ' + str(frame) + '  num: ' + str(i + 1)
...
def main():
    ...
    for name in filename:
        ...
        draw_bee(name.split('.')[0],folder,save_dir="video/")
