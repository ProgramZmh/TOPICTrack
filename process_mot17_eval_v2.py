...
import csv
dataset = 'MOT17'
file_path = 'results/trackers/' + dataset + '-val/' + 'mot17_7_2'
examp_file = '2023-07-01_12-22-23+best_paper_ablations_alpha0.0-gate0.0_post'
listFiles = os.listdir(file_path)

f_test = open(os.path.join(file_path,examp_file,'pedestrian_summary.txt'),'r')
csvfile = open('mot17.csv',mode='w',newline='')
